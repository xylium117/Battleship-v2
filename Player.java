...
public abstract class Player {
    ...
    protected void printStats() {
        System.out.println();
        System.out.println("║");
        System.out.println("║ Statistics of " + playerName + " :");
        System.out.println("║");
        System.out.println("║ Number of shots taken : " + statNbTotalShot);
        System.out.println("║ Number of shots impacted : " + statNbSuccessfullShot);
        System.out.println("║ Accuracy : " + (double) Math.round(((double) (statNbSuccessfullShot) / (double) (statNbTotalShot)) * 100.0) + "%");
        System.out.println("║ Number of ships destroyed : " + statNbBoatShot + "/" + Config.getNbBoats());
        System.out.println("║");
    }
