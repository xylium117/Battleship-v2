...
public class Board {
    ...
    public void showPlayBoard(Player player, Player enemy) {
        ...
        System.out.print("Your grid, " + player.playerName);
        TextHelper.generateSpaceBlanks(titleBlanks1 / 2);
        System.out.print("          ");
        TextHelper.generateSpaceBlanks(titleBlanks2 / 2);
        System.out.print("Grid of " + enemy.getPlayerName());
        TextHelper.generateSpaceBlanks(titleBlanks2 / 2);
        System.out.println(" ");
        ...
        System.out.println();                                                
        System.out.println("╔═════════════════════════════════════╗  ╔═════════════════════════════════════╗");
        System.out.print("║ " + player.playerName + ", here are your ships :");
        TextHelper.generateSpaceBlanks(8 + 46 - (34 + player.playerName.length()));
        System.out.println("║  ║  Here are the ships you have sunk :        ║");
        ...
        if (player.getBoard().getNbBoats() != 0) {
            ...
            System.out.println("║        No ships for the moment         ║");
        }
        System.out.println("╚═════════════════════════════════════╝  ╚═════════════════════════════════════╝");
        System.out.println();
    }
